...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="">
                        <form
                            @submit.prevent="props.course ? form.put(route('course.update', props.course.id)) : form.post(route('course.store'))"
                            class="px-4 mx-auto space-y-3">
                            <div>
                            ...
                            <div>
                                ...
                                <TextInput id="target_enrolee" type="number" class="mt-1 block w-full" v-model="form.target_enrolee"
                                    autofocus />
